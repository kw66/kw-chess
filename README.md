...
KW Chess 的 AI 会按当前关卡规则推演局面，而不是只盯着眼前能不能吃子。传统对弈会严格处理将军、将帅照面等限制；科王和觉醒关卡则会把光波、地震、自爆、冲撞等致命威胁纳入判断，再向后搜索几步，比较不同选择带来的局势变化。
...
<table>
  ...
  <tr>
    ...
    <td>传统、部分觉醒、车马炮兵仕相帅觉醒会走不同规则分支，确保 AI 按当前模式处理走法、将军和特殊技能威胁</td>
  </tr>
  <tr>
