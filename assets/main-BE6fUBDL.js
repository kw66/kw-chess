(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&a(r)}).observe(document,{childList:!0,subtree:!0});function s(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(n){if(n.ep)return;n.ep=!0;const i=s(n);fetch(n.href,i)}})();const R={statsVisitor:"kwChess.stats.visitor",statsLastUvDate:"kwChess.stats.lastUvDate"},Ne="https://ypefmpeekfucmarbbdov.supabase.co",le="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlwZWZtcGVla2Z1Y21hcmJiZG92Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjU5NTA2NTYsImV4cCI6MjA4MTUyNjY1Nn0.XTOQNFuuwfu9nwDTnO9-NEqlzZnzdCVnEmYEJh0rXf8",b={totalPv:"kw_chess_pv_total",totalUv:"kw_chess_uv_total",totalGames:"kw_chess_game_total",dailyPvPrefix:"kw_chess_pv_day",dailyUvPrefix:"kw_chess_uv_day",dailyGamesPrefix:"kw_chess_game_day",survivalMoves:"kw_chess_survival_moves_total",survivalGames:"kw_chess_survival_games_total",survivalMovePrefix:"kw_chess_survival_moves",survivalGamePrefix:"kw_chess_survival_games",killPrefix:"kw_chess_kill"},P=[{type:"R",label:"车"},{type:"H",label:"马"},{type:"C",label:"炮"},{type:"P",label:"兵"},{type:"A",label:"仕"},{type:"B",label:"相"},{type:"K",label:"帅"}];function x(e,t=0,s=99999999){const a=Number(e);return Number.isFinite(a)?Math.min(s,Math.max(t,Math.trunc(a))):t}function je(){return{totalPv:0,totalUv:0,totalGames:0,todayPv:0,todayUv:0,todayGames:0,killsByType:ye(),survivalByType:Fe(),survivalMoves:0,survivalGames:0,avgSurvivalMoves:0}}function Oe(e){const t=e&&typeof e=="object"?e:{},s=x(t.survivalMoves),a=x(t.survivalGames);return{totalPv:x(t.totalPv),totalUv:x(t.totalUv),totalGames:x(t.totalGames),todayPv:x(t.todayPv),todayUv:x(t.todayUv),todayGames:x(t.todayGames),killsByType:j(t.killsByType),survivalByType:O(t.survivalByType),survivalMoves:s,survivalGames:a,avgSurvivalMoves:a>0?Math.round(s/a):0}}async function Re(){const e=be();return e&&await He(),{stats:await Y(),status:e?"全站统计已同步。":"本地预览不会写入全站统计。"}}async function Ke(e={}){if(!be())return{stats:await Y(),status:"本地预览不会写入全站统计。"};const t=H(),s=[M(b.totalGames),M(I(b.dailyGamesPrefix,t))],a=j(e.redKillsByType);for(const o of P){const c=a[o.type]||0;for(let d=0;d<c;d+=1)s.push(M(Z(o.type)))}const n=x(e.totalMoves,0,300);if(n>0){s.push(M(b.survivalGames));for(let o=0;o<n;o+=1)s.push(M(b.survivalMoves))}const i=O(e.redSurvivalByType);for(const o of P){const c=i[o.type],d=x(c.games,0,16),m=d>0?x(Math.round(c.moves/d),0,300):0;d>0&&s.push(M(W(o.type)));for(let f=0;f<m;f+=1)s.push(M(z(o.type)))}return await Promise.all(s),{stats:await Y(),status:"游玩局数已同步。"}}async function He(){const e=H();await Promise.all([M(b.totalPv),M(I(b.dailyPvPrefix,e))]);const t=localStorage.getItem(R.statsVisitor)==="true",s=localStorage.getItem(R.statsLastUvDate),a=[];t||(a.push(M(b.totalUv)),localStorage.setItem(R.statsVisitor,"true")),s!==e&&(a.push(M(I(b.dailyUvPrefix,e))),localStorage.setItem(R.statsLastUvDate,e)),a.length&&await Promise.all(a)}async function Y(){const e=H(),t=I(b.dailyPvPrefix,e),s=I(b.dailyUvPrefix,e),a=I(b.dailyGamesPrefix,e),n=P.map(m=>Z(m.type)),i=P.map(m=>z(m.type)),r=P.map(m=>W(m.type)),o=await De([b.totalPv,b.totalUv,b.totalGames,b.survivalMoves,b.survivalGames,t,s,a,...n,...i,...r]),c={},d={};return P.forEach(m=>{c[m.type]=o[Z(m.type)];const f=o[z(m.type)],g=o[W(m.type)];d[m.type]={moves:f,games:g,avg:g>0?Math.round(f/g):0}}),Oe({totalPv:o[b.totalPv],totalUv:o[b.totalUv],totalGames:o[b.totalGames],todayPv:o[t],todayUv:o[s],todayGames:o[a],survivalMoves:o[b.survivalMoves],survivalGames:o[b.survivalGames],killsByType:c,survivalByType:d})}async function M(e){return fe("increment_counter",{counter_id:e})}async function De(e){const t=await fe("get_counters",{counter_ids:e}),s=Object.create(null);for(const a of e)s[a]=0;if(Array.isArray(t))for(const a of t)a!=null&&a.id&&(s[a.id]=x(a.count));return s}async function fe(e,t){const s=await fetch(`${Ne}/rest/v1/rpc/${e}`,{method:"POST",headers:{apikey:le,Authorization:`Bearer ${le}`,"Content-Type":"application/json"},body:JSON.stringify(t)});if(!s.ok)throw new Error(`统计接口 ${e} 返回 ${s.status}`);const a=await s.text();return a?JSON.parse(a):null}function be(){const e=window.location.hostname;return!e||e==="localhost"||e==="127.0.0.1"||e==="::1"?!1:window.location.protocol==="https:"||window.location.protocol==="http:"}function I(e,t=H()){return`${e}_${t.replaceAll("-","")}`}function Z(e){return`${b.killPrefix}_${e}`}function z(e){return`${b.survivalMovePrefix}_${e}`}function W(e){return`${b.survivalGamePrefix}_${e}`}function ye(){return Object.fromEntries(P.map(e=>[e.type,0]))}function j(e){const t=e&&typeof e=="object"?e:{};return Object.fromEntries(P.map(s=>[s.type,x(t[s.type])]))}function Fe(){return Object.fromEntries(P.map(e=>[e.type,{moves:0,games:0,avg:0}]))}function O(e){const t=e&&typeof e=="object"?e:{};return Object.fromEntries(P.map(s=>{const a=t[s.type]&&typeof t[s.type]=="object"?t[s.type]:{},n=x(a.moves,0,99999999),i=x(a.games,0,99999999);return[s.type,{moves:n,games:i,avg:i>0?Math.round(n/i):0}]}))}function H(e=new Date){const t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${s}-${a}`}const C={sfxEnabled:!0,sfxVolume:70,bgmEnabled:!0,bgmVolume:35,aiStrength:"fair"},G=[{id:"learn",label:"难度 1",time:2e3,note:"熟悉规则稳健落子"},{id:"fair",label:"难度 2",time:4e3,note:"攻防均衡认真对局"},{id:"boss",label:"难度 3",time:8e3,note:"深度搜索挑战极限"}];function de(e,t){const s=Number(e);return Number.isFinite(s)?Math.max(0,Math.min(100,Math.round(s))):t}function D(e){const t=e&&typeof e=="object"?e:{},s=G.some(a=>a.id===t.aiStrength)?t.aiStrength:C.aiStrength;return{sfxEnabled:t.sfxEnabled??C.sfxEnabled,sfxVolume:de(t.sfxVolume,C.sfxVolume),bgmEnabled:t.bgmEnabled??C.bgmEnabled,bgmVolume:de(t.bgmVolume,C.bgmVolume),aiStrength:s}}function Q(e){const t=D(e);return G.find(s=>s.id===t.aiStrength)||G.find(s=>s.id===C.aiStrength)||G[0]}const ke="kw-chess-save";function Ve(){try{const e=localStorage.getItem(ke);return e?JSON.parse(e):null}catch{return null}}function A(e){try{const t={playerLevel:e.playerLevel,playerExp:e.playerExp,starsPerLevel:e.starsPerLevel,highestLevel:e.highestLevel,upgradePoints:e.upgradePoints,pieceUpgrades:e.pieceUpgrades,totalWins:e.totalWins,totalGames:e.totalGames,personalStats:e.personalStats,settings:e.settings,homeMode:e.homeMode};localStorage.setItem(ke,JSON.stringify(t))}catch{}}function Je(){const e=Ve(),t=(e==null?void 0:e.personalStats)||{},s=Math.max(0,Math.trunc(Number(t.survivalMoves)||0)),a=Math.max(0,Math.trunc(Number(t.survivalGames)||0));return{screen:"menu",playerLevel:(e==null?void 0:e.playerLevel)??1,playerExp:(e==null?void 0:e.playerExp)??0,starsPerLevel:(e==null?void 0:e.starsPerLevel)??{},highestLevel:(e==null?void 0:e.highestLevel)??1,upgradePoints:(e==null?void 0:e.upgradePoints)??0,pieceUpgrades:(e==null?void 0:e.pieceUpgrades)??{},totalWins:(e==null?void 0:e.totalWins)??0,totalGames:(e==null?void 0:e.totalGames)??0,personalStats:{killsByType:j(t.killsByType),survivalByType:O(t.survivalByType),survivalMoves:s,survivalGames:a,avgSurvivalMoves:a>0?Math.round(s/a):0},usageStats:je(),usageStatsStatus:"全站统计读取中。",settings:D(e==null?void 0:e.settings),activeHomePanel:null,codexMode:"kw",codexPage:0,homeMode:(e==null?void 0:e.homeMode)==="classic"?"classic":"kw",levelPage:0,selectedChallengeLevel:null,statsScope:"personal",currentLevel:null,currentPlaySource:null}}function Xe(){let e=Je();const t=new Set;function s(){return e}function a(r){const o=typeof r=="function"?r(e):r;e={...e,...o},t.forEach(c=>c(e))}function n(r){return t.add(r),()=>t.delete(r)}function i(r,o={}){var c,d,m,f,g;switch(r){case"navigate":a({screen:o.screen});break;case"usage-stats-updated":a({usageStats:o.stats??e.usageStats,usageStatsStatus:o.status??e.usageStatsStatus});break;case"toggle-home-panel":{const v=o.panel||null;a({activeHomePanel:e.activeHomePanel===v?null:v});break}case"open-home-panel":a({activeHomePanel:o.panel||null});break;case"close-home-panels":a({activeHomePanel:null});break;case"set-codex-mode":a({codexMode:o.mode==="kw"?"kw":"classic",codexPage:0});break;case"set-codex-page":a({codexPage:Math.max(0,Math.trunc(Number(o.page)||0))});break;case"set-home-mode":{const v=o.mode==="classic"?"classic":"kw";a({homeMode:v}),A({...e,homeMode:v});break}case"set-level-page":a({levelPage:Math.max(0,Math.trunc(Number(o.page)||0)),selectedChallengeLevel:null});break;case"set-selected-challenge-level":a({selectedChallengeLevel:Math.max(1,Math.trunc(Number(o.levelId)||1))});break;case"set-stats-scope":a({statsScope:o.scope==="global"?"global":"personal"});break;case"update-settings":{const v=D({...e.settings,...o});a({settings:v}),A({...e,settings:v});break}case"record-personal-stats":{const v=o.stats||{},$={...j((c=e.personalStats)==null?void 0:c.killsByType)},k=j(v.redKillsByType),w={...O((d=e.personalStats)==null?void 0:d.survivalByType)},ee=O(v.redSurvivalByType);Object.keys(ye()).forEach(E=>{var ie,oe,re,ce;$[E]=($[E]||0)+(k[E]||0);const ne=(((ie=w[E])==null?void 0:ie.moves)||0)+(((oe=ee[E])==null?void 0:oe.moves)||0),V=(((re=w[E])==null?void 0:re.games)||0)+(((ce=ee[E])==null?void 0:ce.games)||0);w[E]={moves:ne,games:V,avg:V>0?Math.round(ne/V):0}});const te=Math.max(0,Math.min(300,Math.trunc(Number(v.totalMoves)||0))),F=te>0?(((m=e.personalStats)==null?void 0:m.survivalGames)||0)+1:((f=e.personalStats)==null?void 0:f.survivalGames)||0,ae=(((g=e.personalStats)==null?void 0:g.survivalMoves)||0)+te,se={killsByType:$,survivalByType:w,survivalMoves:ae,survivalGames:F,avgSurvivalMoves:F>0?Math.round(ae/F):0};a({personalStats:se}),A({...e,personalStats:se});break}case"select-level":a({screen:"game",currentLevel:o.levelId,currentPlaySource:o.playSource||"challenge"});break;case"back-to-menu":a({screen:"menu",currentLevel:null,currentPlaySource:null});break;case"back-to-levels":a({screen:"levels",currentLevel:null,currentPlaySource:null});break;case"toggle-upgrade":{const{pieceType:v}=o,y={...e.pieceUpgrades};y[v]?delete y[v]:y[v]=!0,a({pieceUpgrades:y}),A({...e,pieceUpgrades:y});break}case"game-result":{const{newStarBits:v,win:y}=o,$=e.currentLevel,k={...e.starsPerLevel};k[$]=(k[$]||0)|(v||0);const S={starsPerLevel:k,totalWins:e.totalWins+(y?1:0),totalGames:e.totalGames+1};a(S),A({...e,...S});break}default:console.warn(`[Store] 未知 action: ${r}`)}}return{getState:s,setState:a,subscribe:n,dispatch:i}}const pe={rook:"車",horse:"馬",cannon:"炮",pawn:"兵",advisor:"仕",bishop:"相",king:"帅"},Ye=[{id:1,name:"传统象棋",desc:"传统象棋规则入门",icon:"♟",levels:[{id:11,name:"自由对弈",desc:"传统规则，随时开局，无 AI 对手",freePlay:!0,winStarBit:0,starsIndependent:!0,stars:[{desc:"用4种不同棋子吃过子",condition:"capture_4_types",eval:e=>(e.typesCaptured||[]).length>=4}],config:{mode:"classic",noAi:!0}},{id:1,name:"初识象棋",desc:"认识传统象棋每种棋子的走法",starsIndependent:!0,winStarBit:4,stars:[{desc:"移动过每种棋子",condition:"move_all_types",eval:e=>["R","H","C","B","A","P","K"].every(t=>(e.typesMoved||[]).includes(t))},{desc:"用4种不同棋子吃过子",condition:"capture_4_types",eval:e=>(e.typesCaptured||[]).length>=4},{desc:"获胜",condition:"win",eval:e=>!!e.win}],config:{mode:"classic",aiLevel:1,aiTime:4e3,playerUpgrades:{},aiUpgrades:{}},tutorial:[{trigger:"start",text:"欢迎来到象棋世界！每个棋子都有独特的走法。"},{trigger:"select_rook",text:"【車】横竖直走，不限格数，是最强的棋子。"},{trigger:"select_horse",text:'【馬】走"日"字形，先横/竖一步，再斜一步。注意蹩馬腿！'},{trigger:"select_cannon",text:"【炮】移动时像車一样直走，但吃子必须隔一个棋子（炮架）跳吃。"},{trigger:"select_bishop",text:'【相】走"田"字对角，不能过河，且不能被塞象眼。'},{trigger:"select_advisor",text:"【仕】斜走一格，只能在九宫格内移动。"},{trigger:"select_pawn",text:"【兵】未过河只能前进一步，过河后可以左右移动。"},{trigger:"select_king",text:"【帅】在九宫格内横竖移动一格。两帅不能面对面！"}]}]},{id:2,name:"棋子升级",desc:"觉醒后的棋子获得全新能力",icon:"⚡",levels:[{id:2,name:"冲撞",desc:"冲撞友方棋子快速运输",piece:"rook",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"觉醒車击杀达到 3",condition:"rook_kills_3",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.R)||0)>=3}},{desc:"觉醒車击杀达到 5",condition:"rook_kills_5",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.R)||0)>=5}}],config:{mode:"mixed",aiLevel:2,aiTime:4e3,playerUpgrades:{rook:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"你的車已觉醒！觉醒車可冲撞路径上的友方棋子快速运输，同类車还能合体增强。"}]},{id:3,name:"连踩",desc:"十二方位跳跃，借己方棋子连续跳跃，无马脚",piece:"horse",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"一次连踩链 3 个",condition:"chain_kill_3",eval:e=>(e.maxChainKills||0)>=3},{desc:"一次连踩链 5 个",condition:"chain_kill_5",eval:e=>(e.maxChainKills||0)>=5}],config:{mode:"mixed",aiLevel:2,aiTime:4e3,playerUpgrades:{horse:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"你的馬已觉醒！觉醒馬可向十二方跳跃，可借己方棋子连续跳跃，无羁不受蹩腿限制，同类还能合体。"}]},{id:4,name:"翻山",desc:"更宽的炮架，可空投移动",piece:"cannon",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"觉醒炮击杀达到 3",condition:"cannon_kills_3",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.C)||0)>=3}},{desc:"觉醒炮击杀达到 5",condition:"cannon_kills_5",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.C)||0)>=5}}],config:{mode:"mixed",aiLevel:2,aiTime:4e3,playerUpgrades:{cannon:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"你的炮已觉醒！觉醒炮可以翻过连续炮架，远袭炮架后的敌方棋子。"}]},{id:5,name:"自爆",desc:"四向一步，叠层自爆，合体更大爆炸",piece:"pawn",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"兵自爆击杀达到 3",condition:"pawn_explode_3",eval:e=>(e.pawnExplodeKills||0)>=3},{desc:"兵自爆击杀达到 5",condition:"pawn_explode_5",eval:e=>(e.pawnExplodeKills||0)>=5}],config:{mode:"mixed",aiLevel:2,aiTime:4e3,playerUpgrades:{pawn:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"你的兵已觉醒！觉醒兵可上下左右一步移动，同类会自动合体，还能自爆清场。"}]},{id:6,name:"光波",desc:"X光波，合体超级光波，可出宫",piece:"advisor",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"觉醒仕击杀达到 3",condition:"advisor_kills_3",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.A)||0)>=3}},{desc:"觉醒仕击杀达到 5",condition:"advisor_kills_5",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.A)||0)>=5}}],config:{mode:"mixed",aiLevel:2,aiTime:4e3,playerUpgrades:{advisor:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"你的仕已觉醒！觉醒仕可发射远程光波攻击，突破九宫出宫作战，同类还能合体。"}]},{id:7,name:"地震",desc:"十字地震波，合体超级地震波，可过河",piece:"bishop",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"觉醒相击杀达到 3",condition:"bishop_kills_3",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.B)||0)>=3}},{desc:"觉醒相击杀达到 5",condition:"bishop_kills_5",eval:e=>{var t;return(((t=e.redKillsByType)==null?void 0:t.B)||0)>=5}}],config:{mode:"mixed",aiLevel:2,aiTime:4e3,playerUpgrades:{bishop:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"你的相已觉醒！觉醒相可引发地震范围攻击，越河无羁不受塞象眼限制，同类还能合体。"}]}]},{id:3,name:"组合技",desc:"两种觉醒棋子的联动战术",icon:"⚔",levels:[{id:8,name:"御驾亲征",desc:"車冲撞帅出宫",pieces:["rook","king"],winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"王出九宫格",condition:"king_left_palace",eval:e=>!!e.kingLeftPalace},{desc:"王击杀叠层棋子",condition:"king_kills_stacked",eval:e=>(e.kingKillsStacked||0)>=1}],config:{mode:"mixed",aiLevel:3,aiTime:4e3,playerUpgrades:{rook:!0,king:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"组合技·亲征！觉醒車可运载觉醒帅冲锋陷阵，让帅亲自出征消灭敌人。"}]},{id:9,name:"快速运输",desc:"車冲撞兵快速前进",pieces:["rook","pawn"],winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"車运输叠兵",condition:"rook_transport_stacked_pawn",eval:e=>!!e.rookTransportedStackedPawn},{desc:"叠兵到达底线",condition:"stacked_pawn_reached_bottom",eval:e=>!!e.stackedPawnReachedBottom}],config:{mode:"mixed",aiLevel:3,aiTime:4e3,playerUpgrades:{rook:!0,pawn:!0},aiUpgrades:{}},tutorial:[{trigger:"start",text:"组合技·运送炸弹！用觉醒車运送觉醒兵深入敌阵，引爆自爆消灭敌军。"}]}]},{id:4,name:"科王象棋",desc:"全员觉醒，体验科王象棋完整玩法",icon:"👑",levels:[{id:12,name:"自由对弈",desc:"全觉醒规则，双人对局，无 AI 对手",freePlay:!0,winStarBit:0,starsIndependent:!0,stars:[{desc:"用4种不同棋子吃过子",condition:"capture_4_types",eval:e=>(e.typesCaptured||[]).length>=4}],config:{mode:"kw",noAi:!0,playerUpgrades:{rook:!0,cannon:!0,horse:!0,bishop:!0,advisor:!0,pawn:!0},aiUpgrades:{rook:!0,cannon:!0,horse:!0,bishop:!0,advisor:!0,pawn:!0}}},{id:10,name:"科王对决",desc:"双方全员觉醒，体验科王象棋的完整魅力",winStarBit:1,stars:[{desc:"获胜",condition:"win",eval:e=>!!e.win},{desc:"30 步内获胜",condition:"win_in_30",eval:e=>!!e.win&&(e.totalMoves||999)<=60},{desc:"20 步内获胜",condition:"win_in_20",eval:e=>!!e.win&&(e.totalMoves||999)<=40}],config:{mode:"kw",aiLevel:4,aiTime:4e3,playerUpgrades:{rook:!0,cannon:!0,horse:!0,bishop:!0,advisor:!0,pawn:!0},aiUpgrades:{rook:!0,cannon:!0,horse:!0,bishop:!0,advisor:!0,pawn:!0}},tutorial:[{trigger:"start",text:"双方所有棋子完全觉醒！施展所有技巧，体验科王象棋的完整对决。"}]}]}],_=Ye.flatMap(e=>e.levels.map(t=>({...t,tierId:e.id,tierName:e.name})));function $e(e){return _.find(t=>t.id===e)||null}const Ze=_.filter(e=>!e.freePlay).length,we={classic:{label:"传统象棋",short:"传统",emblem:"楚",aiLevelId:1,freeLevelId:11,title:"传统象棋",desc:"按经典规则练基本功：车马炮兵仕相帅，先把每一步走扎实。"},kw:{label:"科王象棋",short:"科王",emblem:"王",aiLevelId:10,freeLevelId:12,title:"科王象棋",desc:"全员觉醒后，叠层、合体、冲撞、连踩和范围技会同时改变战场。"}},ze=3,We=10,K=["rook","horse","cannon","pawn","advisor","bishop","king"],xe={rook:"车",horse:"马",cannon:"炮",pawn:"兵",advisor:"仕",bishop:"相",king:"帅"},qe={rook:"车冲撞运输",horse:"马连踩追击",cannon:"炮翻山远袭",pawn:"兵合体自爆",advisor:"仕出宫光波",bishop:"相过河地震",king:"帅亲征成长"},Qe={1:"认全传统棋子的走法和吃法",2:"用车运送友军，抢出进攻线路",3:"用马连续跳吃，练多段进攻",4:"用炮翻过炮架，远袭关键目标",5:"用兵推进合体，找准爆破时机",6:"用仕出宫远射，练斜线压制",7:"用相越河控场，练十字范围伤害",8:"用车送帅出宫，亲自吃叠子",9:"用车运叠兵，深入敌阵爆破",10:"双方全员，综合使用所有机制"};function l(e,t){return e.map(([s,a])=>({x:s,y:a,type:t}))}function p(e,t,s,a={}){return{x:e,y:t,piece:s,owner:a.owner||"red",layer:a.layer||1,groups:a.groups,type:a.type||"",ghost:!!a.ghost}}function T(e=1,t=1,s=3){const a=[];for(let n=t;n<t+s;n+=1)for(let i=e;i<e+s;i+=1)a.push({x:i,y:n,type:"palace"});return a}function B(e=1,t=1,s=3){return{x:e,y:t,size:s}}function N(e=2.5){return{y:e}}function h(e,t,s={}){return{from:e,to:t,...s}}function u(e,t,s={}){return{title:e,marks:t,...s}}const Se=[{piece:"車",name:"车",title:"横竖直线走，遇到棋子就停",diagrams:[u("空线可走",[...l([[2,0],[2,1],[2,3],[2,4],[0,2],[1,2],[3,2],[4,2]],"move")],{animation:h([2,2],[2,0],{piece:"車"})}),u("挡子与吃子",[...l([[1,2]],"move"),...l([[0,2,"吃"]],"attack"),...l([[3,2,"挡"]],"block"),...l([[4,2,"不可"]],"blocked")],{pieces:[p(0,2,"卒",{owner:"black",type:"attack"}),p(3,2,"兵",{type:"block"})],animation:h([2,2],[0,2],{piece:"車",kind:"attack"})})],sections:[{title:"怎么走",items:["车只走横线或竖线，一次可以走任意格数。","绿色格表示中间没有棋子挡住，所以都可以直接到达。"]},{title:"怎么吃",items:["同一条直线上遇到第一枚敌方棋子时，可以走到敌方棋子所在格并吃掉它。","遇到任何棋子都会停住，不能越过它去吃后面的棋子。"]}]},{piece:"馬",name:"马",title:"走“日”字，马腿被占会被蹩",diagrams:[u("日字落点",[...l([[0,1],[0,3],[1,0],[1,4],[3,0],[3,4],[4,1],[4,3]],"move")],{animation:h([2,2],[0,1],{piece:"馬"})}),u("蹩马腿",[...l([[2,1,"腿"]],"block"),...l([[1,0,"禁"],[3,0,"禁"]],"blocked"),...l([[0,1],[0,3],[1,4],[3,4],[4,1],[4,3]],"move")],{pieces:[p(2,1,"兵",{type:"block"})],animation:h([2,2],[1,0],{piece:"馬",kind:"denied"})})],sections:[{title:"怎么走",items:["马走“日”字：先横或竖一格，再斜一格，最终落在绿色位置。","马不是直线棋子，可以越过大多数棋子，但有一个关键例外。"]},{title:"蹩马腿",items:["如果马正前、正后、正左、正右的“马腿格”被任何棋子占住，那个方向的两个日字落点都不能走。","示意图里上方马腿被红兵占住，所以对应方向的两个灰色落点都不能去。"]}]},{piece:"炮",name:"炮",title:"移动像车，吃子必须隔一个炮架",diagrams:[u("不吃子移动",[...l([[2,0],[2,1],[2,3],[2,4],[0,2],[1,2],[3,2],[4,2]],"move")],{animation:h([2,2],[2,0],{piece:"炮"})}),u("隔架吃子",[...l([[1,2,"架"]],"block"),...l([[3,2,"吃"]],"attack"),...l([[2,2]],"path")],{center:{x:0,y:2},pieces:[p(1,2,"兵",{type:"block"}),p(3,2,"卒",{owner:"black",type:"attack"})],animation:h([0,2],[3,2],{piece:"炮",kind:"attack"})})],sections:[{title:"怎么走",items:["炮不吃子时和车一样，沿横线或竖线移动，不能越过棋子。"]},{title:"怎么吃",items:["炮吃子时必须隔着正好一个棋子，这个被隔着的棋子叫炮架。","炮架可以是双方任意棋子；炮架后遇到的第一枚敌棋才是可吃目标。"]}]},{piece:"兵",name:"兵",title:"未过河只前进，过河后可左右",diagrams:[u("未过河",[...l([[2,2,"进"]],"move"),...l([[1,3,"禁"],[3,3,"禁"],[2,4,"禁"]],"blocked")],{center:{x:2,y:3},river:N(1.5),animation:h([2,3],[2,2],{piece:"兵"})}),u("过河后",[...l([[2,1,"进"],[1,2,"左"],[3,2,"右"]],"move"),...l([[2,3,"禁"]],"blocked")],{river:N(2.5),animation:h([2,2],[1,2],{piece:"兵"})})],sections:[{title:"怎么走",items:["兵每次只走一格。红方朝上前进，黑方朝下前进。","没有过河前只能向前走，不能左右走，也不能后退。"]},{title:"过河以后",items:["过河后可以向前、向左、向右走一格。","兵永远不能后退。"]}]},{piece:"仕",name:"仕",title:"只在九宫内斜走一格",diagrams:[u("九宫内可达",[...T(),...l([[1,1],[3,1],[1,3],[3,3]],"move")],{palace:B(),animation:h([2,2],[1,1],{piece:"仕"})}),u("不能出宫",[...T(),...l([[2,2]],"move"),...l([[0,0],[0,2],[2,0]],"blocked")],{center:{x:1,y:1},palace:B(),animation:h([1,1],[0,0],{piece:"仕",kind:"denied"})})],sections:[{title:"活动范围",items:["仕只能留在己方九宫内，不能出宫。","九宫就是帅周围的 3×3 区域。"]},{title:"不能出宫",items:["仕在九宫角上时，只有仍落在九宫里的斜向格可以走。","灰色叉号表示看起来是斜一步，但落点已经出了九宫，所以不能走。"]}]},{piece:"相",name:"相",title:"走田字，两格斜跳，象眼会挡",diagrams:[u("田字落点",[...l([[0,0],[4,0],[0,4],[4,4]],"move")],{animation:h([2,2],[0,0],{piece:"相"})}),u("塞象眼",[...l([[1,1,"眼"]],"block"),...l([[0,0,"禁"]],"blocked"),...l([[4,0],[0,4],[4,4]],"move")],{pieces:[p(1,1,"兵",{type:"block"})],animation:h([2,2],[0,0],{piece:"相",kind:"denied"})}),u("不能过河",[...l([[0,1],[4,1]],"blocked")],{center:{x:2,y:3},river:N(2.5),animation:h([2,3],[0,1],{piece:"相",kind:"denied"})})],sections:[{title:"怎么走",items:["相沿对角线一次跳两格，也就是走“田”字。","相不能过河，只能在己方半边活动。"]},{title:"塞象眼",items:["如果对角线中间那一格被任何棋子占住，对应方向就不能跳。","示意图里左上方向的象眼被红兵占住，所以左上角的灰色落点不能走。"]},{title:"不能过河",items:["相的落点不能越过河界。","即使“田”字落点看起来对，也不能跳到河对岸的灰色格。"]}]},{piece:"帅",name:"帅",title:"九宫内一步，将帅不能照面",diagrams:[u("九宫一步",[...T(),...l([[2,1],[1,2],[3,2],[2,3]],"move")],{palace:B(),animation:h([2,2],[2,1],{piece:"帅"})}),u("照面禁线",[...T(1,2,3),...l([[2,0,"将"],[2,1,"照"],[2,2,"照"],[2,3,"照"]],"attack")],{center:{x:2,y:4},palace:B(1,2,3),pieces:[p(2,0,"将",{owner:"black",type:"attack"})]})],sections:[{title:"怎么走",items:["帅只能在九宫内横走或竖走一格。","帅不能主动走出九宫。"]},{title:"将帅照面",items:["双方帅/将如果在同一列，中间没有任何棋子挡住，就是违规局面。","走棋时要避免让两位主帅直接面对面。"]}]}],Pe=[{piece:"叠",name:"通用叠层",title:"先看这页：叠层、合体、叠层吃子",diagrams:[u("同类叠层",[...l([[1,2,"車"],[2,2,"叠"],[3,2,"2层"],[4,2]],"combo")],{center:{x:0,y:2},piece:"車",pieces:[p(2,2,"車",{type:"combo"}),p(4,2,"車",{layer:2,groups:[1,1],type:"combo"})],animation:h([0,2],[2,2],{piece:"車",kind:"combo"})}),u("层数吃子",[...l([[3,2,"敌1"],[4,2,"胜"]],"attack"),...l([[1,2,"2层"]],"combo")],{center:{x:1,y:2},piece:"車",centerLayer:2,centerGroups:[2],pieces:[p(4,2,"卒",{owner:"black",type:"attack"})],animation:h([1,2],[4,2],{piece:"車",layer:2,groups:[2],kind:"attack"})}),u("层数不足",[...l([[2,2,"敌3"]],"attack"),...l([[3,2,"剩2"],[4,2]],"block"),...l([[1,2,"败"]],"blocked")],{center:{x:0,y:2},piece:"兵",pieces:[p(2,2,"卒",{owner:"black",layer:3,type:"attack"}),p(4,2,"卒",{owner:"black",layer:2,type:"block",ghost:!0})],animation:h([0,2],[2,2],{piece:"兵",kind:"denied"})})],sections:[{title:"怎么叠",items:["同阵营、同种类的觉醒棋子可以走到一起形成叠层；帅/王不能叠层。","兵最多叠到 5 层，并且叠上去后会自动合体；其他棋子叠上去后先保持为多个小组。"]},{title:"怎么操作",items:["单击叠子会默认带最上面一组行动，剩下的小组留在原格。","双击叠子会打开选择环：多个小组可以选“合”，合体后可以整组行动；合体棋子也可以双击拆出部分层数行动。"]},{title:"怎么吃叠子",items:["吃子只看本次出击的层数和目标总层数。出击层数大于或等于目标层数，就能消灭目标并保留自己的层数。","如果出击层数小于目标层数，进攻方会消失，目标只扣掉对应层数。图中 1 层兵打 3 层敌子会失败，敌子剩 2 层。"]}]},{piece:"車",name:"觉醒车",title:"直线移动，冲撞运输",diagrams:[u("直线移动",[...l([[2,0],[2,1],[2,3],[2,4],[0,2],[1,2],[3,2],[4,2]],"move")],{animation:h([2,2],[2,0],{piece:"車"})}),u("冲撞运输",[...l([[1,2,"撞"],[3,2,"推"],[4,2,"落"]],"skill"),...l([[2,2,"友"]],"ally")],{center:{x:0,y:2},pieces:[p(2,2,"兵",{type:"ally"}),p(4,2,"兵",{type:"skill",ghost:!0})],animations:[h([0,2],[1,2],{piece:"車",kind:"skill"}),h([2,2],[4,2],{piece:"兵",kind:"skill",delay:520})]}),u("车车合体",[...l([[1,2,"車"],[2,2,"叠"],[3,2,"合"],[4,2]],"combo")],{center:{x:0,y:2},pieces:[p(2,2,"車",{type:"combo"}),p(4,2,"車",{layer:2,groups:[2],type:"combo"})],animation:h([0,2],[2,2],{piece:"車",kind:"combo"})})],sections:[{title:"怎么走",items:["觉醒车仍然按车的方式横竖直线移动，不能越过普通阻挡。","遇到敌子时可以按层数规则吃子。"]},{title:"冲撞",items:["如果同一条直线上先有空格、再遇到己方异类棋子，车可以冲到它前一格并把它沿同方向推出。","被推出的棋子遇到己方同类会叠层，遇到敌方会按层数结算；如果把帅推出九宫，就会触发帅的宫外规则。"]},{title:"叠层表现",items:["车车叠层后可合体，合体车能用更高层数吃子或冲撞。","如果被冲撞的是未合体叠子，只推出最底部的小组；合体后才会整体被推出。"]}]},{piece:"馬",name:"觉醒马",title:"十二方跳，不蹩腿，可连踩",diagrams:[u("十二方落点",[...l([[0,1],[0,2],[0,3],[1,0],[1,4],[2,0],[2,4],[3,0],[3,4],[4,1],[4,2],[4,3]],"move")],{animation:h([2,2],[0,1],{piece:"馬"})}),u("借友连跳",[...l([[2,2,"友"],[4,2,"续"]],"skill"),...l([[4,4,"吃"]],"attack"),...l([[2,0,"空"]],"move")],{center:{x:0,y:2},pieces:[p(2,2,"兵",{type:"skill"}),p(4,4,"卒",{owner:"black",type:"attack"})],animations:[h([0,2],[2,2],{piece:"馬",kind:"skill"}),h([2,2],[4,4],{piece:"馬",kind:"attack",delay:520})]}),u("马马合体",[...l([[1,2,"馬"],[2,2,"叠"],[3,2,"合"],[4,2]],"combo")],{center:{x:0,y:2},pieces:[p(2,2,"馬",{type:"combo"}),p(4,2,"馬",{layer:2,groups:[2],type:"combo"})],animation:h([0,2],[2,2],{piece:"馬",kind:"combo"})})],sections:[{title:"怎么走",items:["觉醒马可以跳传统“日”字的 8 个点，也可以直线跳 2 格，总共 12 个方向。","觉醒马没有蹩马腿限制，旁边有棋子也不会挡住它。"]},{title:"连踩",items:["跳到己方棋子上时可以继续从那里再跳；己方异类只是踏点，不会停在上面。","跳到己方马的位置时，可以选择叠层，也可以把它当踏点继续跳。跳到敌方棋子时结束并按层数吃子。"]},{title:"叠层表现",items:["马马合体后，本次出击层数更高，连踩到敌方叠子时更容易吃赢。","未合体时通常只有最上面的小组行动，合体后可以整组跳，也可以拆分部分层数行动。"]}]},{piece:"炮",name:"觉醒炮",title:"直线移动，翻过连续炮架",diagrams:[u("直线移动",[...l([[2,0],[2,1],[2,3],[2,4],[0,2],[1,2],[3,2],[4,2]],"move")],{animation:h([2,2],[2,0],{piece:"炮"})}),u("连续炮架",[...l([[1,2,"架"],[2,2,"架"]],"block"),...l([[3,2,"落"]],"move"),...l([[4,2,"吃"]],"attack")],{center:{x:0,y:2},pieces:[p(1,2,"兵",{type:"block"}),p(2,2,"卒",{owner:"black",type:"block"}),p(4,2,"卒",{owner:"black",type:"attack"})],animation:h([0,2],[4,2],{piece:"炮",kind:"attack"})}),u("炮炮合体",[...l([[1,2,"炮"],[2,2,"叠"],[3,2,"合"],[4,2]],"combo")],{center:{x:0,y:2},pieces:[p(2,2,"炮",{type:"combo"}),p(4,2,"炮",{layer:2,groups:[2],type:"combo"})],animation:h([0,2],[2,2],{piece:"炮",kind:"combo"})})],sections:[{title:"怎么走",items:["不吃子时，觉醒炮可以像车一样沿横线或竖线走。","遇到连续棋子段时，炮可以翻过这段炮架，落到后面的空格。"]},{title:"怎么吃",items:["炮架可以是一段连续棋子；越过炮架后遇到的第一枚敌棋可以被攻击。","如果炮架后遇到的是己方炮，也可以叠层。"]},{title:"叠层表现",items:["炮炮合体后按更高层数远袭，打叠层敌子更强。","未合体炮叠子先是多个小组，双击合体后才会整组行动。"]}]},{piece:"兵",name:"觉醒兵",title:"四向一步，叠层自动合体，自爆连锁",diagrams:[u("四向可走",[...l([[2,1],[1,2],[3,2],[2,3]],"move")],{river:N(2.5),animation:h([2,2],[2,3],{piece:"兵"})}),u("自爆范围",[...l([[1,1,"伤"],[2,1,"伤"],[3,1,"伤"],[1,2,"伤"],[3,2,"伤"],[1,3,"伤"],[2,3,"伤"],[3,3,"伤"]],"attack")],{pieces:[p(1,1,"卒",{owner:"black",type:"attack"}),p(3,3,"马",{type:"attack"})]}),u("兵兵自动合体",[...l([[1,2,"兵"],[2,2,"叠"],[3,2,"合"],[4,2,"爆"]],"combo")],{center:{x:0,y:2},pieces:[p(2,2,"兵",{type:"combo"}),p(4,2,"兵",{layer:2,groups:[2],type:"combo"})]})],sections:[{title:"怎么走",items:["觉醒兵每次可以向上、下、左、右走一格，不再受过河限制。","遇到敌子时按层数规则吃子。"]},{title:"自爆",items:["双击兵可以选择“爆”。自爆后兵自己消失，并攻击周围范围。","自爆半径等于兵的总层数；对非兵棋子每次造成 1 层伤害，双方棋子都会被波及。被炸到的兵会继续连锁自爆。"]},{title:"叠层表现",items:["兵叠到同类兵上会自动合体，最多 5 层。","层数越高，自爆范围越大，因此叠兵是推进和爆破的核心。"]}]},{piece:"仕",name:"觉醒仕",title:"斜走出宫，落地释放 X 形光波",diagrams:[u("出宫斜走",[...T(),...l([[0,0],[0,2],[2,0],[2,2]],"move")],{center:{x:1,y:1},palace:B(),animation:h([1,1],[0,0],{piece:"仕"})}),u("X 形伤害",[...l([[0,0,"伤"],[1,1,"伤"],[3,1,"伤"],[4,0,"伤"],[0,4,"伤"],[1,3,"伤"],[3,3,"伤"],[4,4,"伤"]],"attack")],{pieces:[p(0,0,"卒",{owner:"black",type:"attack"}),p(4,4,"砲",{owner:"black",type:"attack"})]}),u("仕仕合体",[...l([[1,2,"仕"],[2,2,"叠"],[3,2,"强"],[4,2]],"combo")],{center:{x:0,y:2},pieces:[p(2,2,"仕",{type:"combo"}),p(4,2,"仕",{layer:2,groups:[2],type:"combo"})]})],sections:[{title:"怎么走",items:["觉醒仕每次斜走一格，可以出宫，也可以过河。","叠到己方仕时只是叠层，不会触发光波。"]},{title:"光波",items:["仕移动或吃子落地后，会向四条斜线释放 X 形光波。","光波的长度和伤害都等于本次出击的顶组层数；只会伤害敌方棋子。"]},{title:"叠层表现",items:["仕仕合体后，顶组层数变高，光波打得更远、伤害更高。","合体后也可以拆出部分层数行动，用小光波试探。"]}]},{piece:"相",name:"觉醒相",title:"无象眼越河，落地释放十字地震",diagrams:[u("斜跳两格",[...l([[0,1],[4,1]],"move"),...l([[1,2],[3,2]],"path")],{center:{x:2,y:3},river:N(2.5),pieces:[p(1,2,"兵",{type:"path"}),p(3,2,"卒",{owner:"black",type:"path"})],animation:h([2,3],[0,1],{piece:"相"})}),u("十字伤害",[...l([[2,0,"伤"],[2,1,"伤"],[0,2,"伤"],[1,2,"伤"],[3,2,"伤"],[4,2,"伤"],[2,3,"伤"],[2,4,"伤"]],"attack")],{pieces:[p(2,0,"卒",{owner:"black",type:"attack"}),p(4,2,"馬",{owner:"black",type:"attack"})]}),u("相相合体",[...l([[1,2,"相"],[2,2,"叠"],[3,2,"强"],[4,2]],"combo")],{center:{x:0,y:2},pieces:[p(2,2,"相",{type:"combo"}),p(4,2,"相",{layer:2,groups:[2],type:"combo"})]})],sections:[{title:"怎么走",items:["觉醒相仍然斜跳两格，但不再检查象眼，也可以过河。","叠到己方相时只是叠层，不会触发地震。"]},{title:"地震",items:["相移动或吃子落地后，会向上下左右释放十字地震。","地震的长度和伤害都等于本次出击的顶组层数；只会伤害敌方棋子。"]},{title:"叠层表现",items:["相相合体后，十字地震范围和伤害都会提升。","合体相适合站到中路，用十字线压制大片区域。"]}]},{piece:"帅",name:"觉醒帅",title:"九宫八向，吃子成长，可被车送出宫",diagrams:[u("九宫八向",[...T(),...l([[1,1],[2,1],[3,1],[1,2],[3,2],[1,3],[2,3],[3,3]],"move")],{palace:B(),animation:h([2,2],[1,1],{piece:"帅"})}),u("吃子成长",[...l([[2,1,"吃"]],"attack"),...l([[2,0,"+1"]],"combo")],{pieces:[p(2,1,"卒",{owner:"black",type:"attack"}),p(2,0,"帅",{layer:2,groups:[2],type:"combo",ghost:!0})]}),u("车送出宫",[...T(),...l([[2,4,"車"]],"ally"),...l([[2,3,"撞"],[2,1,"出"]],"skill")],{palace:B(),showCenter:!1,pieces:[p(2,4,"車",{type:"ally"}),p(2,0,"帅",{type:"skill",ghost:!0})],animation:h([2,2],[2,0],{piece:"帅",kind:"skill"})})],sections:[{title:"怎么走",items:["觉醒帅在九宫内可以向八个方向走一格，但不能自己主动走出九宫。","如果已经被车冲撞送出宫，宫外帅只能上下左右走一格。"]},{title:"成长",items:["帅成功吃掉敌方棋子并站到目标格后，会增加 1 层。","帅不能叠层，成长是帅提升层数的主要方式。"]},{title:"车送出宫",items:["觉醒车可以冲撞己方帅，把帅推出九宫。","被车送出去的帅可以亲自参战，但也会暴露在更危险的位置。"]}]}];function et(e){let t=0;for(;e;)t+=e&1,e>>=1;return t}function Me(e){return e==="classic"?"classic":"kw"}function tt(e,t=_){return t.reduce((s,a)=>s+et(e[a.id]||0),0)}function at(e=_){return e.reduce((t,s)=>t+s.stars.length,0)}function st(e,t=_){return t.filter(s=>s.freePlay?!1:((e[s.id]||0)&(s.winStarBit??1))!==0).length}function _e(e,t){return((t[e.id]||0)&(e.winStarBit??1))!==0}function U(e,t){const s=_.find(i=>i.id===e);if(s!=null&&s.freePlay||e===1)return!0;const a=_.find(i=>i.id===e-1);return a?((t[e-1]||0)&(a.winStarBit??1))!==0:!0}function L(e){const t=Math.max(0,Math.trunc(Number(e)||0));return t>=1e5?`${(t/1e4).toFixed(1)}万`:String(t)}function Ee(e){return`${Math.max(0,Math.round(Number(e)||0))}步`}function Le(e,t){return Math.max(0,Math.trunc(Number(e==null?void 0:e[t])||0))}function Te(e,t){const s=e==null?void 0:e[t];if(!s||typeof s!="object")return 0;const a=Math.max(0,Math.trunc(Number(s.games)||0)),n=Math.max(0,Math.trunc(Number(s.moves)||0));return a>0?Math.round(n/a):0}function Be(e){return e==="global"?"global":"personal"}function ue(e,t,s){const a=t===e;return`<button class="stats-scope-button ${a?"is-active":""}" type="button" data-info-stats-scope="${e}" aria-pressed="${a}">${s}</button>`}function nt(e,t,s="personal"){const a=Be(s),n=a==="global"?t:e,i=(n==null?void 0:n.killsByType)||{},r=(n==null?void 0:n.survivalByType)||{};return`
      ...
      <div class="home-desktop-piece-grid">
        ${P.map(a=>`
          <span class="home-desktop-piece">
            <b>${a.label}</b>
            <em>击杀${L(Le(t,a.type))}</em>
            <i>存活${Ee(Te(s,a.type))}</i>
          </span>
        `).join("")}
      </div>
    ...
    <b>${t}</b>
  </button>`}function me(e,t){const s=we[e],a=t===e;return`<button class="home-mode-button ${a?"is-active":""}" data-home-mode="${e}" type="button" aria-pressed="${a}">
    <span>${s.emblem}</span><b>${s.label}</b>
  </button>`}function ot(e){return`${(Math.max(0,Number(e)||0)/1e3).toFixed(e%1e3===0?0:1)} 秒`}function rt(e){return Qe[e.id]||e.desc}function ve(e={},t="kw"){return t==="classic"?[]:t==="kw"?K:K.filter(s=>e[s])}function ge(e,t){return t.length?t.length===K.length?`${e}全员`:`${e}${t.map(s=>xe[s]||s).join("、")}`:`${e}传统棋子`}function ct(e){const t=e.config||{},s=t.mode||"kw",a=ve(t.playerUpgrades,s),n=ve(t.aiUpgrades,s),i=K.filter(o=>a.includes(o)||n.includes(o)),r=i.length?i.map(o=>qe[o]||`${xe[o]||o}能力`).join("，"):"按传统走法练基础移动与吃子";return`
    <div class="challenge-force-brief">
      <p><b>兵力</b><span>${ge("我方",a)}，${ge("敌方",n)}</span></p>
      <p><b>能力</b><span>${r}</span></p>
    </div>`}function lt(e){const t=String(e||"").replace(/\s+/g,""),s={移动过每种棋子:"移动全部棋子",用4种不同棋子吃过子:"4种棋子吃子",获胜:"获胜",車运输叠兵:"车运叠兵",叠兵到达底线:"叠兵到底线",王出九宫格:"帅出九宫",王击杀叠层棋子:"帅吃叠子"};return s[t]?s[t]:t.replace(/觉醒車/g,"觉醒车").replace(/^觉醒/g,"").replace(/擊/g,"击").replace(/达到/g,"").replace(/一次连踩链/g,"马连踩").replace(/步内获胜/g,"步内胜")}function dt(e){const t=Me(e.homeMode),s=we[t],a=_.find(o=>o.id===s.aiLevelId),n=_.find(o=>o.id===s.freeLevelId),i=Q(e.settings),r=e.totalGames>0?`${Math.round(e.totalWins/e.totalGames*100)}%`:"0%";return`
    <section class="home-play-panel" aria-label="开局选择">
      ...
      ${it(e.personalStats)}
    </section>`}function Ce(){return _.filter(e=>!e.freePlay)}function pt(e,t){return`<div class="challenge-star-goals" aria-label="星级条件">
    ${e.stars.map((s,a)=>{const n=t>>a&1;return`<span class="challenge-star-chip ${n?"is-earned":""}"><b>${n?"★":"☆"}</b><em>${lt(s.desc)}</em></span>`}).join("")}
  </div>`}function ut(e,t,s){var c;const a=t[e.id]||0,n=U(e.id,t),i=_e(e,t),r=Number(e.id)<10?`0${e.id}`:e.id,o=n&&Number(e.id)===Number(s);return`
    <article class="challenge-level-card ${i?"is-completed":""} ${o?"is-selected":""} ${n?"is-playable":"is-locked"}"
      ...
      ${ct(e)}
      ${pt(e,a)}
    </article>`}function mt(e,t,s,a){const n=e.find(r=>Number(r.id)===Number(a)&&U(r.id,s));if(n)return n;const i=e.find(r=>U(r.id,s));return i||t.find(r=>U(r.id,s)&&!_e(r,s))||t.find(r=>U(r.id,s))||null}function vt(e,t,s,a){var m;const n=Ce(),i=typeof window<"u"&&((m=window.matchMedia)!=null&&m.call(window,"(min-width: 1024px)").matches)?We:ze,r=Math.max(1,Math.ceil(n.length/i)),o=Math.min(Math.max(0,e.levelPage||0),r-1),c=n.slice(o*i,(o+1)*i),d=mt(c,n,e.starsPerLevel,e.selectedChallengeLevel);return`
    <section class="challenge-panel" aria-label="关卡模式">
      <header class="challenge-head">
        ...
        <div class="challenge-summary">
          <span>通关 <b>${t}/${n.length||Ze}</b></span>
          <span>★ <b>${s}/${a}</b></span>
        </div>
      </header>
      <div class="challenge-level-list">
        ${c.map(f=>ut(f,e.starsPerLevel,d==null?void 0:d.id)).join("")}
      </div>
    ...
    </section>`}function gt(e){const t=e.usageStats||{},s=e.personalStats||{},a=Be(e.statsScope);return`
    ...
    <article class="home-modal-block info-stats-block">
      ...
      <div class="usage-inline-stats" aria-live="polite">
        <span><b>访问 ${L(t.totalPv)}</b><em>今日 ${L(t.todayPv)}</em></span>
        <span><b>访客 ${L(t.totalUv)}</b><em>今日 ${L(t.todayUv)}</em></span>
        <span><b>游玩 ${L(t.totalGames)}</b><em>今日 ${L(t.todayGames)}</em></span>
      </div>
    ...
    </article>`}const ht={車:"车",馬:"马",炮:"炮",兵:"兵",仕:"仕",相:"相",帅:"帅",叠:"叠"};function ft(e,t="red"){return t==="red"&&ht[e]||e}function q(e,t){const s=e.owner==="black"?"black":"red",a=ft(e.piece||t.piece,s),n=a==="帅"||a==="将"?"is-king-piece":"",i=Math.max(1,Math.trunc(Number(e.layer)||1)),r=Array.isArray(e.groups)&&e.groups.length?e.groups.map(c=>Math.max(1,Math.trunc(Number(c)||1))):i>1?[i]:[],o=r.length>1?"is-unmerged":"is-merged";return`<span class="rule-piece is-${s} ${n} ${e.ghost?"is-ghost":""}" aria-hidden="true">
    <span class="rule-piece-core">${a}</span>
    ${r.length?`<span class="rule-piece-badges ${o}">
      ${r.map(c=>`<i>${c}</i>`).join("")}
    </span>`:""}
  </span>`}function Ie(e){return Array.isArray(e.animations)?e.animations:e.animation?[e.animation]:[]}function bt(e,t,s,a){const n=Array.isArray(t.from)?t.from:[Math.floor(s/2),Math.floor(s/2)],i=Array.isArray(t.to)?t.to:n,r=(Number(n[0])+.5)/s*100,o=(Number(n[1])+.5)/s*100,c=(Number(i[0])+.5)/s*100,d=(Number(i[1])+.5)/s*100,m=r+(c-r)*.42,f=o+(d-o)*.42,g=["move","attack","skill","combo","denied"].includes(t.kind)?t.kind:"move",v=[`--from-left:${r.toFixed(4)}%`,`--from-top:${o.toFixed(4)}%`,`--to-left:${c.toFixed(4)}%`,`--to-top:${d.toFixed(4)}%`,`--bump-left:${m.toFixed(4)}%`,`--bump-top:${f.toFixed(4)}%`,`--anim-delay:${Number(t.delay??a*180)}ms`].join(";");return`<span class="rule-anim-piece is-${g}-demo" style="${v}">
    ${q({piece:t.piece||e.piece,owner:t.owner||"red",layer:t.layer||1,groups:t.groups,ghost:t.ghost},e)}
  </span>`}function yt(e,t,s){const a=[];if(e.palace){const n=e.palace,i=Number(n.size||3),r=Number(n.x||0)/t*100,o=Number(n.y||0)/t*100,c=i/t*100;a.push(`<span class="rule-palace-frame" style="--palace-left:${r.toFixed(4)}%;--palace-top:${o.toFixed(4)}%;--palace-size:${c.toFixed(4)}%"></span>`)}if(e.river){const n=Number(e.river.y||0)/t*100;a.push(`<span class="rule-river-line" style="--river-top:${n.toFixed(4)}%"></span>`)}return Ie(e).forEach((n,i)=>{a.push(bt(s,n,t,i))}),a.join("")}function kt(e,t){const s=t.size||5,a=t.center||{x:Math.floor(s/2),y:Math.floor(s/2)},n=new Map;(t.marks||[]).forEach(c=>{const d=`${c.x},${c.y}`,m=n.get(d)||[];m.push(c),n.set(d,m)});const i=new Map((t.pieces||[]).map(c=>[`${c.x},${c.y}`,c])),r=Ie(t),o=[];for(let c=0;c<s;c+=1)for(let d=0;d<s;d+=1){const m=n.get(`${d},${c}`)||[],f=i.get(`${d},${c}`),g=d===a.x&&c===a.y,v=t.showCenter!==!1&&!r.length,y=[...new Set(m.map(k=>k.type).filter(Boolean))].map(k=>`is-${k}`).join(" "),$=f?q(f,e):g&&v?q({piece:t.piece||e.piece,owner:t.centerOwner||"red",layer:t.centerLayer||1,groups:t.centerGroups},e):"";o.push(`<span class="rule-cell ${g?"is-center":""} ${y}">${$}</span>`)}return`<div class="rule-mini-board ${r.length?"has-animation":""}" style="--board-size:${s}" aria-hidden="true">${o.join("")}${yt(t,s,e)}</div>`}function $t(e,t){return`
    <div class="rule-diagram">
      ${kt(e,t)}
    </div>`}function wt(e){const t=e==="kw"?Pe:Se,s=[];return t.forEach((a,n)=>{const i=a.diagrams||(a.diagram?[a.diagram]:[]),r=i.length?i:[u(a.name,[],{showCenter:!0})];r.forEach((o,c)=>{s.push({rule:a,ruleIndex:n,diagramIndex:c,diagram:o,pageInRule:c,pagesInRule:r.length})})}),s}function xt(e,t,s){return(e==="kw"?Pe:Se).map((n,i)=>{const r=t.findIndex(d=>d.ruleIndex===i),o=r>=0?r:0,c=n.piece==="叠"?"叠层":n.name.replace(/^觉醒/,"").replace(/^通用/,"");return`
      <button type="button" data-codex-page="${o}" class="${s===i?"is-active":""}" aria-pressed="${s===i}">
        <b>${c}</b>
      </button>`}).join("")}function St(e,t){var c,d;const{rule:s,diagram:a,diagramIndex:n,pageInRule:i,pagesInRule:r}=e,o=((c=s.sections)==null?void 0:c[n])||((d=s.sections)==null?void 0:d[0])||{items:s.lines||[]};return`
    ...
    </div>`}function Mt(e,t=0){const s=e==="kw"?"kw":"classic",a=wt(s),n=Math.min(a.length-1,Math.max(0,Math.trunc(Number(t)||0))),i=a[n],r=n<=0?a.length-1:n-1,o=n>=a.length-1?0:n+1;return`
    ...
    </section>`}function _t(e){const t=D(e),s=Q(t);return`
    ...
    ${X("author","游戏信息",gt(e),e.activeHomePanel)}
    ${X("codex","棋子图鉴",Mt(e.codexMode,e.codexPage),e.activeHomePanel,Pt(e.codexMode))}
    ${X("settings","设置",_t(e.settings),e.activeHomePanel)}`}function he(e){const t=Me(e.homeMode),s=Ce(),a=tt(e.starsPerLevel,s),n=at(s),i=st(e.starsPerLevel,s);return`
    <div class="home-page">
    ...
    </div>`}function Nt(e,t,s){var r,o,c;const a=new URLSearchParams;a.set("levelId",e.id);const n=Ue(e,t,s);n&&(a.set("ai","1"),a.set("aiTime",String(n.time)),a.set("aiStrength",n.id));const i=((r=e.config)==null?void 0:r.mode)??"kw";if(a.set("mode",i),i==="classic"&&a.set("classic","1"),i!=="classic"){const d=((o=e.config)==null?void 0:o.playerUpgrades)||{},m=((c=e.config)==null?void 0:c.aiUpgrades)||{},f=Object.keys(d).filter(v=>d[v]).join(","),g=Object.keys(m).filter(v=>m[v]).join(",");f&&a.set("pu",f),g&&a.set("au",g)}return`./index-legacy.html?${a.toString()}`}function jt(e){var y,$,k;const t=$e(e.currentLevel);if(!t)return`<div class="game-page">
      <div class="page-header">
        <button class="btn-back" data-action="back-to-menu">&larr; 返回</button>
        <h2 class="page-title">关卡不存在</h2>
      </div>
    </div>`;const s=e.starsPerLevel[t.id]||0,a=Bt(s),n=t.stars.length,i=t.pieces?t.pieces.map(S=>pe[S]).join(" "):t.piece?pe[t.piece]:"",r=Ue(t,e.settings,e.currentPlaySource),o=Nt(t,e.settings,e.currentPlaySource),c=(r==null?void 0:r.label)||"",d=!((y=t.config)!=null&&y.noAi)&&c,m={classic:"传统",mixed:"觉醒",kw:"科王"}[(($=t.config)==null?void 0:$.mode)??"kw"]||"科王",f=t.freePlay?"双人":"红方",g=t.freePlay?'<span class="game-header-badge">自由对弈</span>':d?`<span class="game-header-badge game-header-ai">AI · ${c}</span>`:'<span class="game-header-badge">双人对局</span>',v=(k=t.tutorial)!=null&&k.length?t.tutorial[0].text:"";return`
    <div class="game-page">
      <!-- ── 页头：关卡名 + AI强度 + 星星 ── -->
        ...
        <div class="game-info-panel" id="game-info-panel">
          ...
          <div class="info-section panel-hint">
            ...
            <div class="hint-display ${v?"":"hint-empty"}"
                 id="hint-display"
                 data-default="${Ct(v)}">${v||"选择棋子查看走法"}</div>
          </div>
